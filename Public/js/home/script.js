...
function changeInfoSlideshow() {
    temp = $(".flipster__item--current .flipster__item__content img").attr('src');
    temp = "<img src='"+temp+"'>";
    $(".background__slideshow").html(temp);
    temp = $(".flipster__item--current .flipster__item__content .title_slide").html();
    $(".title__slides").html(temp);
    temp = $(".flipster__item--current .flipster__item__content .intro_slide").html();
    $(".intro__slides").html(temp);
}
$( () => {
    ...
    // slideshow
    changeInfoSlideshow();
    $(".flipster__item").on("click", () => {
        changeInfoSlideshow();
    });
    $(".flipster__button").on("click", () => {
        changeInfoSlideshow();
    });
    setTimeout(function() {
        timePlaySlideshow = 3000;
    }, 200);
